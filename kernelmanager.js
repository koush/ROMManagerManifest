{
  ...
  "roms": [
    ...
    {
      "device": "glacier",
      "modversion": "MaxOC~1.84GHz BFS",
      "url": "http://kernels.teamw.in/files/185-GB-Kernel-2.5.0-121-BFS-SV.zip",
      "name": "AOSP Kernel for the MyTouch 4G",
      "summary": "This kernel is basedlined from the CM7 source, with the .38 drivers merged in.\n\nAndroid Version: 2.3\n\nLinux Kernel Version: 2.6.38\n\nOS Type: CM"
    },
    {
      "device": "glacier",
      "modversion": "MaxOC~1.84GHz CFS",
      "url": "http://kernels.teamw.in/files/186-GB-Kernel-2.5.0-123-CFS-SV.zip",
      "name": "AOSP Kernel for the MyTouch 4G",
      "summary": "This kernel is basedlined from the CM7 source, with the .38 drivers merged in.\n\nAndroid Version: 2.3\n\nLinux Kernel Version: 2.6.38\n\nOS Type: CM"
    },
    {
    ...
    },
    {
      ...
      "name": "300-1800 Low Voltage",
      "summary": "Low voltage oc'd to 1800 with a min freq of 300 for a quicker wake up.Built from initial HTC source drop. All source is on git\n\nAndroid Version: 2.2\n\nLinux Kernel Version: 2.6.32.21\n\nOS Type: SENSE"
    }
  ]
}